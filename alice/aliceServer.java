...
//    private DatagramSocket socket;
    ...
    private static aliceServer rsaObj = new aliceServer();
    ...
    public static void main(String[] args){
        ...
        String successStr = "Successfully! Welcome back Bob!";
        ...
        try{
            ...
            System.out.println("Alice (Server) is connecting ...");
            ...
            System.out.println("Received K from Client");
            ...
            while(true){
                ...
                if(cipherRC4Str.equalsIgnoreCase("exit")){
                    System.out.println("Bob has disconnected!");
                    System.out.println("Shutting Down the Program...");
                    System.exit(-1);
                }
                System.out.println("Bob Sent:");
                ...
                //byte[] buffer2 = echoString.getBytes();
